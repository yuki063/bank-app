						...
						<div className='col-lg-8'>
							<div className='form-content'>
								<div className='section-header'>
									<h2 className='title'>Where do you live most of the time?</h2>
								...
								<form action='#'>
									<div className='bottom-area text-center'>
										...
										<div className='bottom-area'>
											<Link href='/register/varify-number' className='cmn-btn'>
												Continue
											</Link>
										</div>
									</div>
								...
								<div className='btn-back mt-60 d-flex align-items-center'>
									<Link href='/register/account-type' className='back-arrow'>
